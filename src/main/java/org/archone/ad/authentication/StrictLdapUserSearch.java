 ...
 * @see SearchControls
 */
public class StrictLdapUserSearch implements LdapUserSearch {
    //~ Static fields/initializers =====================================================================================

    private static final Log logger = LogFactory.getLog(StrictLdapUserSearch.class);
    ...
    public StrictLdapUserSearch(String searchBase, String searchFilter, BaseLdapPathContextSource contextSource) {
    ...
    public DirContextOperations searchForUser(String username) {
        ...
        String userDnParts[] = parseDn(username);
        ...
        try {
            ...
            return template.searchForSingleEntry(searchBase + "," + userDnParts[1], searchFilter, new String[] {userDnParts[0]});
    ...
    public String[] parseDn(String email) {
        ...
        for(String dc : domainPart.split("\\.")) {
            dn.append("dc=");
            dn.append(dc);
            dn.append(",");
        }
                
        dn.deleteCharAt(dn.toString().length() - 1);
        
        return new String[] { username, dn.toString() }; 
    }
