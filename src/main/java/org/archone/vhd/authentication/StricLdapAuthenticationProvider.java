 ...
 */
public class StricLdapAuthenticationProvider implements AuthenticationProvider, MessageSourceAware {
    //~ Static fields/initializers =====================================================================================

    private static final Log logger = LogFactory.getLog(StricLdapAuthenticationProvider.class);
     ...
     *          authenticated.
     */
    public StricLdapAuthenticationProvider(LdapAuthenticator authenticator, LdapAuthoritiesPopulator authoritiesPopulator) {
     ...
     */
    public StricLdapAuthenticationProvider(LdapAuthenticator authenticator) {
        this.setAuthenticator(authenticator);
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            if(userDetailsContextMapper instanceof UserAttrsContextMapping) {
                ((UserAttrsContextMapping) userDetailsContextMapper).setPassword(password);
            }
